...
: ${AMENT_CURRENT_PREFIX:="/home/yx/code/ros2study/2/src/tf/install/tf"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/tf/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/tf/environment/path.sh"
